...
func (c *servicesClient) ChatService(ctx context.Context, opts ...grpc.CallOption) (Services_ChatServiceClient, error) {
	stream, err := c.cc.NewStream(ctx, &Services_ServiceDesc.Streams[0], "/commsvr.Services/ChatService", opts...)
	if err != nil {
		return nil, err
	}
...
var Services_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "syncdc-server/api/protobuf-spec/commsvr/chat.proto",
}
